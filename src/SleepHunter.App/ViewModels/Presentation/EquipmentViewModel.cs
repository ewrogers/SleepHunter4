...
namespace SleepHunter.ViewModels.Presentation
{
        ...
        IEnumerable<InventoryItemViewModel>
    {
        ...
        private readonly InventoryItemViewModel[] equipment =
            new InventoryItemViewModel[EquipmentCount];
        private readonly IconManager icons;

        public IEnumerable<InventoryItemViewModel> SortedBySlot =>
            equipment.OrderBy(item => item.Slot);

        public EquipmentViewModel(IconManager icons = null)
        {
            this.icons = icons;
