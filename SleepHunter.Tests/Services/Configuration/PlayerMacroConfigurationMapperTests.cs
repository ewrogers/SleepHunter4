...
public sealed class PlayerMacroConfigurationMapperTests
{
    [Test]
    public void ShouldRoundTripCompleteCurrentConfiguration()
    {
        using var sourcePlayer = CreatePlayer("Source");
        var source = new PlayerMacroConfiguration(sourcePlayer)
        {
        ...
        var mapper = new PlayerMacroConfigurationMapper();
        ...
        using var destinationPlayer = CreatePlayer("Destination");
        var destination =
            new PlayerMacroConfiguration(destinationPlayer);
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(
                ...
                Has.All.Property(nameof(SpellQueueItem.IsUndefined))
                    .True);
            Assert.That(
    ...
    public void ShouldImportUnknownLegacyEntriesWithoutDiscardingThem()
    {
        ...
        var destination = new PlayerMacroConfiguration(player);
        var mapper = new PlayerMacroConfigurationMapper();
