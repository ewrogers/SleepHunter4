...
{
    public sealed class ClientPollingCoordinator :
        IDisposable,
        IAsyncDisposable
    {
        ...
        private readonly Func<TimeSpan> getClientInterval;
        ...
        private readonly Action updateClients;
            ...
            ILogger logger)
        {
            ...
            this.updateClients = updateClients ??
                throw new ArgumentNullException(
                    nameof(updateClients));
            this.getProcessInterval = getProcessInterval ??
                throw new ArgumentNullException(
                    nameof(getProcessInterval));
            this.getClientInterval = getClientInterval ??
                throw new ArgumentNullException(
                    nameof(getClientInterval));
        ...
        private ValueTask PollClientsAsync(
            CancellationToken cancellationToken)
        {
            cancellationToken.ThrowIfCancellationRequested();
            updateClients();
