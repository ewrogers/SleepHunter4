...
namespace SleepHunter.Views
{
    ...
    public partial class MainWindow : Window
   {
      ...
      {
         if (player == null || string.IsNullOrWhiteSpace(player.Name)) return;
      ...
      {
         if (spellQueueListBox == null) return;
      ...
      void Window_Closing(object sender, CancelEventArgs e)
      {
         ...
         try { ClientVersionManager.Instance.SaveToFile(ClientVersionManager.VersionsFile); }
         catch(Exception ex)
         {
         ...
         try { ColorThemeManager.Instance.SaveToFile(ColorThemeManager.ThemesFile); }
         catch(Exception ex)
         {
            this.ShowMessageBox("Save Error",
         ...
         try { UserSettingsManager.Instance.SaveToFile(UserSettingsManager.SettingsFile); }
         catch(Exception ex)
         {
            this.ShowMessageBox("Save Error",
         ...
         try { SkillMetadataManager.Instance.SaveToFile(SkillMetadataManager.SkillMetadataFile); }
         catch(Exception ex)
         {
            this.ShowMessageBox("Save Error",
         ...
         try { SpellMetadataManager.Instance.SaveToFile(SpellMetadataManager.SpellMetadataFile); }
         catch(Exception ex)
         {
            this.ShowMessageBox("Save Error",
         ...
         try { StaffMetadataManager.Instance.SaveToFile(StaffMetadataManager.StaffMetadataFile); }
         catch(Exception ex)
         {
            this.ShowMessageBox("Save Error",
         ...
         try { FileArchiveManager.Instance.ClearArchives(); }
         catch { }
